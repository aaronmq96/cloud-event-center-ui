...
const UpdateUserInfo = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`${REACT_APP_BASE_API_URL}/user/createUser`, userPayload)
            ...
            <div className='register-content'>
                ...
                <Form>
                    ...
                    <Form.Group className="mb-3" controlId="formGridFullName">
                        ...
                        <Form.Control className="input-main" placeholder="Full Name" onChange={(e) => {
                            console.log(e.target.value)
                    ...
                    <Form.Group className="mb-3" controlId="formGridScreenName">
                        ...
                        <Form.Control className="input-main" placeholder="UserName" onChange={(e) => setScreenName(e.target.value)} value={screenName} />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="formGridDescription">
                        ...
                        <Form.Control className="input-main" placeholder="Description" as="textarea" rows={3}
                    ...
                    <Button variant="primary" type="submit" style={{ minWidth: "250px", minHeight: "60px", fontSize: '24px' }} onClick={handleUpdate} >
                        Update
                    </Button>
